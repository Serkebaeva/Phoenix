...
//e. Напишите программу для следующей задачи: Компьютер спрашивает названия двух планет, радиусы их орбит (в миллионах километров) и скорости движения по орбите (в миллионах километров в сутки). Компьютер вы-числяет продолжительность года на планетах и выдает результат в консоли в виде: Продолжительность года на планете Земля – 365 суток, а на планете Эоэлла – 12 суток //

let planet1 = prompt("Назовите первую планету", "Земля");
let radius1 = Number(prompt("Назовите радиус орбиты первой планеты", "149"));
let orbitalSpeed1 = Number(
  prompt("Назовите скорость движения по орбите", "29.78")
);

let s1 = 2 * Math.PI * radius1;
/*let s2 = 2 * Math.PI * radius2*/

let year1 = s1 / orbitalSpeed1;

console.log(year1);

/*let planet2 = prompt("Назовите Вторую планету", "Эоэлла");
let radius2 = Number(prompt("Назовите радиус орбиты второй планеты", "12"));
let orbitalSpeed2 = Number(
  prompt("Назовите скорость движения по орбите", "30")
);*/

/*console.log(
  `Продолжительность года на планете ${planet1} – ${
    (2 * Math.PI * radius1) / orbitalSpeed1
  } суток, а на планете ${planet2} – ${
    (2 * Math.PI * radius2) / orbitalSpeed2
  } суток`
);*/
...
//*****365 = 2*3,14* 149,6 / х */
//***х = 2*3,14* 149,6 / 365 ***////
/*console.log(2 * 3, 14 * 149, 6 / 365);*/
//***12 =  2*3,14* 149,6 / х */
//***х = 2*3,14* 149,6 / 12 ***////
/*console.log(2 * 3, 14 * 149, 6 / 12);*/
/*T=2пr/v
...
if (userAge > 17) {
  ...
  alert(`${univerInfo} Хороший институт`);
} else {
  let schoolInfo = prompt("В какой школе ты учишься?", "61");
  alert(`${schoolInfo} Неплохая школа`);
}
