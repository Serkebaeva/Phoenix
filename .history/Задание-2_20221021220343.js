...
console.log(`Продолжительность года на планете ${planet1} – ${2 * Math.PI * radius1/orbitalSpeed1} суток, а на планете ${planet2} – ${2 * Math.PI * radius1/orbitalSpeed2} суток`);*/
