...
class WorkingHours extends Restaurant {
  constructor(restaurantName, cuisineType, openHours) {
    super(restaurantName, cuisineType);

    this.openHours = openHours;
  }

  sayOpenHours() {
    console.log(`We are open every day from/to ${this.openHours}`);
  }
}

let WorkingHours1 = new WorkingHours("O'Nell", "Italian", "10am - 11pm");
